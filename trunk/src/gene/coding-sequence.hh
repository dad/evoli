...
#ifndef CODING_SEQUENCE_HH
#define CODING_SEQUENCE_HH
...
*/
class CodingDNA : public NucleotideSequence {
private:
protected:
public:
	CodingDNA();
	CodingDNA(const CodingDNA& g);
	CodingDNA(const string& s) : NucleotideSequence(s) {}
