/***************************************************************************
    ...
    $Id: cutee.cc,v 1.29 2004/02/27 18:14:21 tat Exp $
 ***************************************************************************/
...
struct GenAutomakefile
{
	...
	void writeMakefile()
	{
		...
		_( "\trm -f autocutee.mk cutee *.o *.cutee.cc "RUNTEST_NAME" "RUNTEST_NAME".cc");
		_( "\ttouch autocutee.mk");

		_( "" );
		_( "EXTRA_PROGRAMS="RUNTEST_NAME );
		_( RUNTEST_NAME "_SOURCES="RUNTEST_NAME".cc $(test_files) $(t_runners)");
